...
# creat the object
model_chm=capsule_hm.capsule_hm(features=None, M=M, K=K, J=J, visible_type=visible_type, visible_type_fixed_param=visible_type_fixed_param, hidden_type=hidden_type, hidden_type_fixed_param=hidden_type_fixed_param, tol_poisson_max=8, xz_interaction=xz_interaction, rng=rng)
# create a folder to save the results
dir_save=model_chm.make_dir_save(parent_dir_save, prefix, learn_rate_a_pretrain, learn_rate_b_pretrain, learn_rate_c_pretrain, learn_rate_W_pretrain, maxiter_pretrain+maxiter_train, normalization_method)
# make a copy of this script in dir_save
shutil.copy(workdir+"main_test_ExpCHM_MNIST.py", dir_save)
...
#_,_=model_chm.generate_samples(NS=100, NMF=100, method="Gibbs", sampling_time=4, sampling_num_iter=100, row=28, col=28, dir_save=dir_save, prefix="pretrain_"+prefix)
